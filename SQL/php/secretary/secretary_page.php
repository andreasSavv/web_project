...
<div class="container">
    ...
    <div class="card">
        <h3>Μενού</h3>
        <ul class="menu">
            <li><a href="secretary_view_diplo.php">📚 Προβολή Διπλωματικών εργασιών</a></li>
            <li><a href="secretary_data.php">👤 Εισαγωγή δεδομένων</a></li>
            <li><a href="secretary_thesis_manage.php">🛠 Διαχείριση διπλωματικής</a></li>
        </ul>
    </div>

    <div class="card">
        <h3>Πληροφορίες λογαριασμού</h3>
        <p><span class="label">Ρόλος:</span> <span class="value">Γραμματεία</span></p>
        <?php if ($secretary): ?>
            <?php if (!empty($secretary['secretary_user_id'])): ?>
                <p><span class="label">Αριθμός Μητρώου:</span> <span class="value"><?php echo htmlspecialchars($secretary['secretary_user_id']); ?></span></p>
            <?php endif; ?>
            <?php if (!empty($secretary['secretary_email'])): ?>
                <p><span class="label">Email:</span> <span class="value"><?php echo htmlspecialchars($secretary['secretary_email']); ?></span></p>
            <?php endif; ?>
        <?php else: ?>
            <p>Δεν βρέθηκαν επιπλέον στοιχεία γραμματείας στη βάση.</p>
        <?php endif; ?>
    </div>
</div>
</body>
